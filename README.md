...
• Analyzed the dataset of an organization and provided insights to improve employee performance and improve employee retention (reduce attrition) by creating an analytic dashboard.
